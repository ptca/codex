...
exports.db = exports.createServer = void 0;
...
var datastore_1 = require("../datastore/inmemory/datastore");
var datastore_2 = require("../datastore/postgres/datastore");
...
function createServer(datastore) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            switch (datastore) {
                case "inmemory":
                    exports.db = db = new datastore_1.InMem();
                    break;
                case "postgres":
                    exports.db = db = new datastore_2.Postgres();
                    break;
                default:
                    exports.db = db = new datastore_1.InMem();
                    break;
